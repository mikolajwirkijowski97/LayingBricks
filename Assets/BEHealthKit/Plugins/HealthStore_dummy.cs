...
namespace BeliefEngine.HealthKit
{
	...
	internal static class HealthStoreDummyExtensions
	{
		...
		public static void _ReadStatistics_DUMMY(this HealthStore store, string identifier, string startDate, string endDate, string predicateString, string options) {
