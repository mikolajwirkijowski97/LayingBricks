...
@property (nonatomic, strong) NSDictionary *longRunningQueries; /*!< @brief keeps track of long-running queries */
...
/*! @brief				Registers a long-running query for a sample type.
	@details			This is used by the plugin to keep track of observer queries.
	@param query    	The query in question.
	@param sampleType   The sample type the query is for.
 */
