...
+ (NSString *)XMLFromWorkoutSamples:(NSArray *)workoutSamples workoutType:(HKWorkoutActivityType)workoutType error:(NSError *)error;             /*!< @brief generate XML from an array of WorkoutSamples */
